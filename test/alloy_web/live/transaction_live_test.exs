defmodule AlloyWeb.TransactionLiveTest do
  use AlloyWeb.ConnCase

  import Phoenix.LiveViewTest
  import Alloy.BudgetsFixtures

  @create_attrs %{type: "some type", date: "2026-09-11", description: "some description", amount: 42}
  @update_attrs %{type: "some updated type", date: "2026-09-12", description: "some updated description", amount: 43}
